    ...
    <div className='wrapper'>
      ...
      <div className='answers'>
        <button
          ...
          onClick={handleClick}
          ref={
            randomAnswerOption[0] === randomCountry.name ? rightAnswer : null
          }
          disabled={IsNext}>
        ...
        <button
          ...
          onClick={handleClick}
          ref={
            randomAnswerOption[1] === randomCountry.name ? rightAnswer : null
          }
          disabled={IsNext}>
        ...
        <button
          ...
          onClick={handleClick}
          ref={
            randomAnswerOption[2] === randomCountry.name ? rightAnswer : null
          }
          disabled={IsNext}>
        ...
        <button
          ...
          onClick={handleClick}
          ref={
            randomAnswerOption[3] === randomCountry.name ? rightAnswer : null
          }
          disabled={IsNext}>
